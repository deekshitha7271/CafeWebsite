                     ...
                     <div className="text-center">
                        <div className="flex items-center justify-center gap-2 mb-4">
                           <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
                              <span className="text-background font-serif font-black text-sm">C.</span>
                           </div>
                           <span className="text-lg font-serif font-bold text-white tracking-widest uppercase">Ca Phe</span>
                        </div>
                        <h4 className="text-primary text-[8px] font-black uppercase tracking-[0.6em] mb-8">Bistro Ritual</h4>
                     </div>
